...
<main id="container">
    ...
    <form action="signup.php" method="POST" id="myform">
        ...
        <input type="text" id="username" name="username" required pattern="^[a-zA-Z0-9_]+$" title="Only letters, numbers, and underscores allowed." placeholder="srijana"><br>
        ...
        <input type="text" id="phone_number" name="phone_number" required pattern="^\+(\d{1,4})\s?\d{10}$"
               placeholder="+123 1234567890"><br>

...
$notifications = [];
if ($userId) {
    $sqlNotifications = "SELECT message FROM notifications WHERE user_id = ? ORDER BY created_at DESC";
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const notifications = <?php echo json_encode($notifications); ?>; // Fetch notifications from PHP
